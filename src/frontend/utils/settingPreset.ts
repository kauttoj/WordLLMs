...
export const settingPreset = {
  ...
  anthropicReasoningEffort: selectSetting('medium', 'anthropicReasoningEffort', ['low', 'medium', 'high', 'xhigh']),
  ...
  azureReasoningEffort: selectSetting('medium', 'azureReasoningEffort', ['low', 'medium', 'high']),
  ...
  geminiReasoningEffort: selectSetting('medium', 'geminiReasoningEffort', ['low', 'medium', 'high']),
  ...
  enableAgentTodos: checkboxSetting(false, 'enableAgentTodos'),
