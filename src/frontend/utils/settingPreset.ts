...
export const settingPreset = {
  ...
  officialMaxContextTokens: inputNumSetting(128000, 'maxContextTokens', 'maxTokens'),
  ...
  anthropicTemperature: inputNumSetting(0.7, 'anthropicTemperature', 'temperature'),
  ...
  agentMaxIterations: inputNumSetting(50, 'agentMaxIterations', 'maxTokens'),
  enableMarkdown: checkboxSetting(false, 'enableMarkdown'),
  horizontalToolCalls: checkboxSetting(true, 'horizontalToolCalls'),
  attachmentCharLimit: inputNumSetting(50000, 'attachmentCharLimit', 'maxTokens'),
  llmTimeout: inputNumSetting(60, 'llmTimeout', 'maxTokens'),
